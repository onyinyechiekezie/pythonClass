...
class TestCubeFunction(TestCase):
	def test_that_cube_exists(self):
	...
	def_test_cube_function_raise_exception_with_invalid_input(self):
		self.assertRaises(TypeError, functionpractise.get_cube, "moses")

	def_test_that_cube_function_return_correct_value_with_float(self):
